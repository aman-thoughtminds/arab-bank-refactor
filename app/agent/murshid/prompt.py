...
{{
    ...
    "available_tools": [
        {{
            "name": "general_similarity_search",
            "description": "Searches pinecone for relevant internal documents and SOPs based on query, this vector store has all the answers to the questions that the user might ask.",
            "parameters": {{
                "query": "Required string, this is the question that the user has asked",
            }}
        }}
    ],
    "tool_calling_instruction": "Everytime call the general_similarity_search tool with appropriate parameters. Wait for the tool response before continuing.",
